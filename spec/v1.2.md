...
# 📜 IMAGXP Protocol Specification (v1.2)
**Status**: Stable / Draft
**Version**: 1.2.0
...
| :--- | :--- | :--- |
| `User-Agent` | Must contain "IMAGXP/1.2". | Yes |
...
To solve the "Micro-Transaction Problem" (sending $0.001 is too expensive), IMAGXP v1.2 introduces the **Broker Role**.
